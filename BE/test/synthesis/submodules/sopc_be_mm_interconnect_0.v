...
module sopc_be_mm_interconnect_0 (
	...
	wire  [94:0] sysid_1_control_slave_agent_rf_source_data;                                // sysid_1_control_slave_agent:rf_source_data -> sysid_1_control_slave_agent_rsp_fifo:in_data
	...
	wire  [94:0] sysid_1_control_slave_agent_rsp_fifo_out_data;                             // sysid_1_control_slave_agent_rsp_fifo:out_data -> sysid_1_control_slave_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> sysid_1_control_slave_agent:cp_valid
	wire  [93:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> sysid_1_control_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // sysid_1_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> sysid_1_control_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> sysid_1_control_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> sysid_1_control_slave_agent:cp_endofpacket
	...
	wire  [94:0] gpio_out_s1_agent_rf_source_data;                                          // gpio_out_s1_agent:rf_source_data -> gpio_out_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] gpio_out_s1_agent_rsp_fifo_out_data;                                       // gpio_out_s1_agent_rsp_fifo:out_data -> gpio_out_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> gpio_out_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> gpio_out_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // gpio_out_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> gpio_out_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> gpio_out_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> gpio_out_s1_agent:cp_endofpacket
	...
	wire  [94:0] gpio_in_s1_agent_rf_source_data;                                           // gpio_in_s1_agent:rf_source_data -> gpio_in_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] gpio_in_s1_agent_rsp_fifo_out_data;                                        // gpio_in_s1_agent_rsp_fifo:out_data -> gpio_in_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> gpio_in_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> gpio_in_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // gpio_in_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> gpio_in_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> gpio_in_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> gpio_in_s1_agent:cp_endofpacket
	...
	wire         sysid_1_control_slave_agent_rp_valid;                                      // sysid_1_control_slave_agent:rp_valid -> router_003:sink_valid
	wire  [93:0] sysid_1_control_slave_agent_rp_data;                                       // sysid_1_control_slave_agent:rp_data -> router_003:sink_data
	wire         sysid_1_control_slave_agent_rp_ready;                                      // router_003:sink_ready -> sysid_1_control_slave_agent:rp_ready
	wire         sysid_1_control_slave_agent_rp_startofpacket;                              // sysid_1_control_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         sysid_1_control_slave_agent_rp_endofpacket;                                // sysid_1_control_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         gpio_out_s1_agent_rp_valid;                                                // gpio_out_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] gpio_out_s1_agent_rp_data;                                                 // gpio_out_s1_agent:rp_data -> router_007:sink_data
	wire         gpio_out_s1_agent_rp_ready;                                                // router_007:sink_ready -> gpio_out_s1_agent:rp_ready
	wire         gpio_out_s1_agent_rp_startofpacket;                                        // gpio_out_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         gpio_out_s1_agent_rp_endofpacket;                                          // gpio_out_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         gpio_in_s1_agent_rp_valid;                                                 // gpio_in_s1_agent:rp_valid -> router_008:sink_valid
	wire  [93:0] gpio_in_s1_agent_rp_data;                                                  // gpio_in_s1_agent:rp_data -> router_008:sink_data
	wire         gpio_in_s1_agent_rp_ready;                                                 // router_008:sink_ready -> gpio_in_s1_agent:rp_ready
	wire         gpio_in_s1_agent_rp_startofpacket;                                         // gpio_in_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         gpio_in_s1_agent_rp_endofpacket;                                           // gpio_in_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         sysid_1_control_slave_agent_rdata_fifo_src_valid;                          // sysid_1_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] sysid_1_control_slave_agent_rdata_fifo_src_data;                           // sysid_1_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         sysid_1_control_slave_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_001:in_0_ready -> sysid_1_control_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> sysid_1_control_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> sysid_1_control_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // sysid_1_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> sysid_1_control_slave_agent:rdata_fifo_sink_error
	...
	wire         gpio_out_s1_agent_rdata_fifo_src_valid;                                    // gpio_out_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] gpio_out_s1_agent_rdata_fifo_src_data;                                     // gpio_out_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         gpio_out_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_005:in_0_ready -> gpio_out_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> gpio_out_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> gpio_out_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // gpio_out_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> gpio_out_s1_agent:rdata_fifo_sink_error
	wire         gpio_in_s1_agent_rdata_fifo_src_valid;                                     // gpio_in_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] gpio_in_s1_agent_rdata_fifo_src_data;                                      // gpio_in_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         gpio_in_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> gpio_in_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> gpio_in_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> gpio_in_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // gpio_in_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> gpio_in_s1_agent:rdata_fifo_sink_error
	...
	sopc_be_mm_interconnect_0_router_002 router_006 (
